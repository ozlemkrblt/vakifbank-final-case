...
public class GetReceiptInfoByIdQueryHandler : IRequestHandler<GetReceiptInfoByIdQuery, ApiResponse<ReceiptInfoResponse>>
{
    private readonly ECommerceDbContext dbContext;
    private readonly IMapper mapper;
    public GetReceiptInfoByIdQueryHandler(ECommerceDbContext dbContext, IMapper mapper)
    {
    ...
    public async Task<ApiResponse<ReceiptInfoResponse>> Handle(GetReceiptInfoByIdQuery request,
