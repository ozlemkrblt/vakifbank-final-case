...
public class UpdateProductCommandValidator : AbstractValidator<UpdateProductCommand>
{
    public UpdateProductCommandValidator()
    {
        ...
        RuleFor(x => x.Model.StockId).NotEmpty().WithMessage("Stock Information is required.");
        RuleFor(x => x.Model.StockId).GreaterThan(0).WithMessage("Stock Information should be greater than 0.");
